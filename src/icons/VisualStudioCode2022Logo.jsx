...
const VisualStudioLogo = (props) => (
  ...
  >
    <defs>
      <path
        id="visual_studio__reuse-0"
        fill="#fff"
        d="M8.271 8.271h176.457v176.457H8.271z"
      />
    </defs>
    <g clipPath="url(#visual_studio__a)">
      <g clipPath="url(#visual_studio__b)">
        <mask
          id="visual_studio__c"
          width={177}
          height={177}
    ...
    <defs>
      ...
      <clipPath id="visual_studio__a">
        <use xlinkHref="#visual_studio__reuse-0" />
      </clipPath>
